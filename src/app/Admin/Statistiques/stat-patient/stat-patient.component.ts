  ...
  series: [
    {
      ...
      data: [
        { value: this.allPatientsSainSelonAutoDetection, name: 'Patients Sains' },
        { value: this.allPatientsMaladeSelonAutoDetection, name: 'Patients Malades' , selected: true}
      ]
    },
    {
      name: 'Patients',
      ...
      data: [
        { value: this.allPatientsSainSelonAutoDetection, name: 'Patients Saines' },
        { value: 310, name: 'Pathologie 1' },
        { value: 251, name: 'Pathologie 2' },
        { value: 234, name: 'Pathologie3' },
        { value: 147, name: 'Pathologie 4' },
        { value: 135, name: 'Pathologie 5' },
      ]
    }
  ]
};
