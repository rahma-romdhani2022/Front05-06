...
const routes: Routes = [
  ...
  {path:"historiqueDroite/:idConsultation" , component: HistDroiteComponent, canActivate: [AuthGuardExpert]},
  {path:"historiqueGauche/:idConsultation" , component: HistGaucheComponent, canActivate: [AuthGuardExpert]},
